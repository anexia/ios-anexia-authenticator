...
internal enum Asset {
  ...
  internal static let socialInstagram = ImageAsset(name: "social_instagram")
  ...
  internal static let socialLargeFacebook = ImageAsset(name: "SocialLargeFacebook")
  internal static let socialLargeGithub = ImageAsset(name: "SocialLargeGithub")
  internal static let socialLargeInstagram = ImageAsset(name: "SocialLargeInstagram")
